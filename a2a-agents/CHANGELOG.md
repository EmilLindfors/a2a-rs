...
## [0.7.0](https://github.com/EmilLindfors/a2a-rs/compare/a2a-agents-v0.6.0...a2a-agents-v0.7.0) - 2026-08-15
...
- *(a2a-agents)* Probe registered agents for liveness, and rank the dead behind the living
- *(a2a-agents)* Resolve delegation peers when the tool is called, not at startup
- *(a2a-agents)* Delegation waits on the peer's event stream, and says how the peer ended
