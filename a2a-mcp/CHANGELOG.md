...
## [0.11.0](https://github.com/EmilLindfors/a2a-rs/compare/a2a-mcp-v0.10.2...a2a-mcp-v0.11.0) - 2026-09-23

### Fixed

- *(a2a-rs)* Connectrpc 0.9.1 and buffa 0.9.2, past RUSTSEC-2026-0304

## [0.10.2](https://github.com/EmilLindfors/a2a-rs/compare/a2a-mcp-v0.10.1...a2a-mcp-v0.10.2) - 2026-09-07

### Added

- *(a2a-mcp)* A question a server asks mid-call reaches the A2A side
- *(a2a-mcp)* A slow agent behind the bridge is a task, not a blocked call
...
- A2a-mcp on rmcp 3.2, MCP 2026-07-28

## [0.9.0](https://github.com/EmilLindfors/a2a-rs/compare/a2a-mcp-v0.8.1...a2a-mcp-v0.9.0) - 2026-09-04

### Added

- MCP for a data server — typed tools, resources, elicitation, names

## [0.8.1](https://github.com/EmilLindfors/a2a-rs/compare/a2a-mcp-v0.8.0...a2a-mcp-v0.8.1) - 2026-09-03
...
## [0.6.1](https://github.com/EmilLindfors/a2a-rs/compare/a2a-mcp-v0.6.0...a2a-mcp-v0.6.1) - 2026-08-18

### Changed

- Split the workspace along protocol vs platform

## [0.6.0](https://github.com/EmilLindfors/a2a-rs/compare/a2a-mcp-v0.5.0...a2a-mcp-v0.6.0) - 2026-08-15

### Added

- *(a2a-rs)* Carry the authenticated caller to the message handler

## [0.5.0](https://github.com/EmilLindfors/a2a-rs/compare/a2a-mcp-v0.4.1...a2a-mcp-v0.5.0) - 2026-07-31
