...
## [0.10.0](https://github.com/EmilLindfors/a2a-rs/compare/a2a-rs-v0.9.2...a2a-rs-v0.10.0) - 2026-09-23

### Fixed

- *(a2a-rs)* Connectrpc 0.9.1 and buffa 0.9.2, past RUSTSEC-2026-0304

## [0.9.2](https://github.com/EmilLindfors/a2a-rs/compare/a2a-rs-v0.9.1...a2a-rs-v0.9.2) - 2026-09-07

### Other

- Clippy 1.98 refuses an index used only under the tracing feature

## [0.9.1](https://github.com/EmilLindfors/a2a-rs/compare/a2a-rs-v0.9.0...a2a-rs-v0.9.1) - 2026-09-04

### Added

- AgentCard::extension looks an extension up by URI
...
- *(a2a-rs)* A ConnectRPC refusal arrives as the refusal the server made
...
## [0.8.1](https://github.com/EmilLindfors/a2a-rs/compare/a2a-rs-v0.8.0...a2a-rs-v0.8.1) - 2026-08-27

### Fixed

- SqlxTaskStorage never stored a task's status message
...
- *(a2a-rs)* End a subscription once the task settles
- *(a2a-rs)* Stamp the transport an HttpServer actually mounts on its card
